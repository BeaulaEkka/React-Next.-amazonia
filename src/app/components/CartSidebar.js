...
export const CartSidebar = () => {
  ...
  return (
    <div className="w-32 h-full shadow-lg border-l border-l-gray-700 overflow-scroll bg-white hidden md:block lg:block">
      {loading ? (
        ...
        <>
          <div className="py-5 flex flex-col items-center border border-b-gray-600">
            <div>subtotal</div>
